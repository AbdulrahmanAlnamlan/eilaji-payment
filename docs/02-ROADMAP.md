...
| 1.10 | Money-math bug fixes behind goldens: tilt hardware pricing, Georgian-bar reinforcement/material, unify `roundMoney`, round stored subtotal/total | 1.1 | S | todo 🔶 (fix now vs freeze) |

...
function demoLinks() {
  ...
  return [
    ...
    {
      slug: 'h1',
      title: 'اشترك في علاجي بريميوم',
      titleEn: 'Subscribe to Eilaji Premium',
      description: 'لا تفوّت أي جرعة بعد الآن. تنبيهات ذكية، مواعيد طبية، وأدوية غير محدودة.',
      descriptionEn: 'Never miss a dose again. Smart alerts, medical appointments, unlimited medications.',
      logoText: 'علاجي',
      logoSubText: 'EILAJI',
      brandColor: '#06B6D4',
      currency: 'QAR',
      ...
      amount: 0,
      plans: [
        { id: 'monthly', name: 'شهري', nameEn: 'Monthly', amount: 29, period: 'شهرياً', periodEn: 'per month' },
        { id: '3months', name: '٣ أشهر', nameEn: '3 Months', amount: 75, period: 'كل ٣ أشهر', periodEn: 'every 3 months', badge: 'الأكثر شيوعاً', badgeEn: 'Most popular' },
        { id: 'yearly', name: 'سنوي', nameEn: 'Yearly', amount: 199, period: 'سنوياً', periodEn: 'per year', badge: 'وفّر ٤٣٪', badgeEn: 'Save 43%' },
      ],
      collectName: true,
      collectEmail: true,
      collectPhone: true,
      collectNote: false,
      successMessage: 'مرحباً بك في علاجي بريميوم. افتح التطبيق للاستمتاع بجميع المزايا.',
      successMessageEn: 'Welcome to Eilaji Premium. Open the app to enjoy every feature.',
      redirectUrl: '',
      active: true,
